...
<x-layout bodyClass="g-sidenav-show bg-gray-200">
    ...
    {{-- 2. INCLURE LA BARRE LATÉRALE en utilisant le composant --}}
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <x-navbars.navs.auth titlePage="Modifier une Mesure"></x-navbars.navs.auth>
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Modifier une mesure de santé</h6>
                            </div>
                        </div>
                        <div class="card-body px-0 pb-2">
                            <div class="table-responsive p-0">
                                <div class="container mt-3">
                                    <form action="{{ route('sante-mesures.update', $mesure) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="number" step="0.1" name="poids_kg" id="poids_kg"
                                                                   class="form-control border p-2" required
                                                                   value="{{ old('poids_kg', $mesure->poids_kg) }}"
                                                                   min="20" max="300">
                                                        </div>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="number" name="taille_cm" id="taille_cm"
                                                                   class="form-control border p-2" required
                                                                   value="{{ old('taille_cm', $mesure->taille_cm) }}"
                                                                   min="50" max="300">
                                                        </div>
                                                        ...
                                                        <div id="new_regime_fields">
                                                                ...
                                                                <div class="regime-select-wrapper">
                                                                    <select name="type_regime" id="type_regime"
                                                                        ...
                                                                        <option value="Diabète" class="regime-option regime-diabète"
                                                                                {{ old('type_regime', $mesure->regime ? $mesure->regime->type_regime : '') == 'Diabète' ? 'selected' : '' }}>
                                                                            <i class="material-icons">local_hospital</i> Diabète
                                                                        </option>
                                                                        <option value="Hypertension" class="regime-option regime-hypertension"
                                                                                {{ old('type_regime', $mesure->regime ? $mesure->regime->type_regime : '') == 'Hypertension' ? 'selected' : '' }}>
                                                                            <i class="material-icons">favorite</i> Hypertension
                                                                        </option>
                                                                        <option value="Grossesse" class="regime-option regime-grossesse"
                                                                                {{ old('type_regime', $mesure->regime ? $mesure->regime->type_regime : '') == 'Grossesse' ? 'selected' : '' }}>
                                                                        ...
                                                                        <option value="Cholestérol élevé (hypercholestérolémie)" class="regime-option regime-cholestérol élevé (hypercholestérolémie)"
                                                                                {{ old('type_regime', $mesure->regime ? $mesure->regime->type_regime : '') == 'Cholestérol élevé (hypercholestérolémie)' ? 'selected' : '' }}>
                                                                        ...
                                                                        <option value="Maladie cœliaque (intolérance au gluten)" class="regime-option regime-maladie cœliaque (intolérance au gluten)"
                                                                                {{ old('type_regime', $mesure->regime ? $mesure->regime->type_regime : '') == 'Maladie cœliaque (intolérance au gluten)' ? 'selected' : '' }}>
                                                                        ...
                                                                        <option value="Insuffisance rénale" class="regime-option regime-insuffisance rénale"
                                                                                {{ old('type_regime', $mesure->regime ? $mesure->regime->type_regime : '') == 'Insuffisance rénale' ? 'selected' : '' }}>
                                                            ...
                                                            <div class="mb-4">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="number" step="0.01" name="valeur_cible"
                                                                           ...
                                                                           value="{{ old('valeur_cible', $mesure->regime ? $mesure->regime->valeur_cible : '') }}"
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea name="description" id="description"
                                                                          ...
                                                                          placeholder="Décrivez votre régime et vos objectifs...">{{ old('description', $mesure->regime ? $mesure->regime->description : '') }}</textarea>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="number" name="freq_cardiaque" id="freq_cardiaque"
                                                                   class="form-control border p-2" required
                                                                   value="{{ old('freq_cardiaque', $mesure->freq_cardiaque) }}"
                                                                   min="30" max="220">
                                                        </div>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="number" name="tension_systolique" id="tension_systolique"
                                                                   class="form-control border p-2" required
                                                                   value="{{ old('tension_systolique', $mesure->tension_systolique) }}"
                                                                   min="70" max="250">
                                                        </div>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="number" name="tension_diastolique" id="tension_diastolique"
                                                                   class="form-control border p-2" required
                                                                   value="{{ old('tension_diastolique', $mesure->tension_diastolique) }}"
                                                                   min="40" max="150">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card-body">
                                                <div class="mb-3">
                                                    <textarea name="remarque" id="remarque" class="form-control border p-2"
                                                              rows="3">{{ old('remarque', $mesure->remarque) }}</textarea>
                                                </div>
                                            </div>
                                        </div>
